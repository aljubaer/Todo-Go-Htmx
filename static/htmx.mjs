...
(function(module) {
  (function(ze, Qr) {
    ...
    return function() {
      var Q = { onLoad: B, process: zt, on: de, off: ge, trigger: ce, ajax: Nr, find: C, findAll: f, closest: v, values: function(ze, Qr) {
      ...
      function Se(ze, Qr) {
        for (var Jr = Br(Qr), Zr = 0; Zr < Jr.length; Zr++) {
          var Gr = Jr[Zr];
          try {
      ...
      function Ee(ze, Qr, Jr) {
        ...
        return Yr ? (oe(Yr, function(Wr) {
          ...
          ce(Wr, "htmx:oobBeforeSwap", tn) && (Wr = tn.target, tn.shouldSwap && Be(Gr, Wr, Wr, Kr, Jr), oe(Jr.elts, function(rn) {
      ...
      function Be(ze, Qr, Jr, Zr, Gr) {
        switch (ze) {
          ...
          case "delete":
            ...
            return;
          default:
            for (var Yr = Br(Qr), Wr = 0; Wr < Yr.length; Wr++) {
              var Kr = Yr[Wr];
              try {
            ...
            ze === "innerHTML" ? Ue(Jr, Zr, Gr) : Be(Q.config.defaultSwapStyle, Qr, Jr, Zr, Gr);
        }
      }
      function Ve(ze) {
      ...
      function je(ze, Qr, Jr, Zr, Gr, Yr) {
        ...
        var Wr = l(Zr);
        if (Wr)
          return Ce(Jr, Wr, Gr), Wr = Fe(Jr, Wr, Yr), Re(Wr), Be(ze, Jr, Qr, Wr, Gr);
      }
...
`), Gr = null, Yr = 0; Zr.length > 0; ) {
            ...
            Yr === 0 && Kr ? (Wr.split(":"), Gr = Kr[1].slice(0, -1), Jr[Gr] = Kr[2]) : Jr[Gr] += Wr, Yr += Ft(Wr);
          }
          for (var en in Jr)
            Bt(ze, en, Jr[en]);
        }
        ...
        for (var Qr = 0; Qr < ze.attributes.length; Qr++) {
          ...
          if (g(Jr, "hx-on") || g(Jr, "data-hx-on")) {
            ...
            if (Yr === "-" || Yr === ":") {
              ...
              g(Wr, ":") ? Wr = "htmx" + Wr : g(Wr, "-") ? Wr = "htmx:" + Wr.slice(1) : g(Wr, "htmx-") && (Wr = "htmx:" + Wr.slice(5)), Bt(ze, Wr, Zr);
            }
          }
        }
      }
      ...
      function he(ze, Qr, Jr, Zr, Gr, Yr) {
        ...
        var Sn = Jr, pn = ne(Jr, "hx-sync"), mn = null, Un = !1;
        if (pn) {
        ...
        var ln = { xhr: an, target: nn, requestConfig: cn, etc: Gr, boosted: Fn, select: rn, pathInfo: { requestPath: Qr, finalRequestPath: bn, anchor: Dn } };
